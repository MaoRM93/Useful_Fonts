...
一个自用 + 分享的常用字体合集，主要给中文用户准备：思源黑体、思源宋体、微软雅黑、宋体、仿宋、楷体、方正系列，外加 Google Sans / Noto Sans 等英文字体。

> 说人话：这里就是个「下载 → 解压 → 安装」就能用的字体包，照着下面来就行，不用懂任何技术。
...
**能商用吗？**
思源、阿里巴巴普惠体、Noto 都是开源 / 免费可商用；微软雅黑、宋体等微软字体，以及方正字体的商用授权请自行确认——个人自用一般没问题。
